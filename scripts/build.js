...
// Scanner seed (verified Cloudflare anycast IPs) — injected as a JS array
// into the HTML (regenerated by scripts/build-colopool.mjs from the fresh
// community clean-IP dataset, filtered to official Cloudflare ranges).
let scanIpsJson = "[]";
